...
ParticulAir is an open-source air quality monitoring device built around an ESP32. It measures particulate matter (PM2.5 / PM10) using a PMS5003 sensor and reports readings over MQTT.
